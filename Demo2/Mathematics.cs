...
public static class Mathematics
{
    ...
    static long Add(int value1, int value2) => value1 + value2;
    static long Add(int value1, int value2, int value3) => value1 + value2 + value3;

    public static long Add(int value1, int value2, params int[] otherValues)
    {
        long result = value1 + value2;
        foreach(int value in otherValues)
        {
            result += value;
        }
